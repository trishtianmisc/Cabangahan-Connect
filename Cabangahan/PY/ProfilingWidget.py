...
class ProfilingWindow(QtWidgets.QWidget):
    def __init__(self, official_window):
        super().__init__()
        ui_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'UI', 'ProfilingUI.ui'))
        uic.loadUi(ui_path, self)

        self.official_window = official_window
    ...
    def getdata(self):
        ...
        try:
            ...
            self.official_window.loadtable()
